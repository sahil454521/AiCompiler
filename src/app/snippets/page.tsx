    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 text-white">
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="relative max-w-5xl mx-auto mb-12 space-y-6">
          ...
          {/* Filters Bar */}
          <div className="flex flex-wrap items-center gap-4 bg-white/5 backdrop-blur-md rounded-xl p-4 ring-1 ring-white/10 shadow">
        ...
        {filteredSnippets.length === 0 && (
          <motion.div
            ...
            className="relative max-w-md mx-auto mt-20 p-8 rounded-2xl overflow-hidden bg-white/5 backdrop-blur-md ring-1 ring-white/10 shadow"
          >
